...
import com.seafile.vmoo.account.Authenticator;
import com.seafile.vmoo.avatar.Avatar;
import com.seafile.vmoo.avatar.AvatarManager;
import com.seafile.vmoo.monitor.FileMonitorService;
import com.seafile.vmoo.ui.adapter.AccountAdapter;
import com.seafile.vmoo.ui.adapter.SeafAccountAdapter;
...
public class AccountsActivity extends BaseActivity implements Toolbar.OnMenuItemClickListener{
    ...
    public void onStart() {
        ...
        bindService(bIntent, mMonitorConnection, BIND_AUTO_CREATE);
    }
