...
public class Authenticator extends AbstractAccountAuthenticator {
    ...
    private com.seafile.vmoo.account.AccountManager manager;
    ...
    public Authenticator(Context context) {
        ...
        this.manager = new com.seafile.vmoo.account.AccountManager(context);
    }
    ...
    public Bundle confirmCredentials(
        ...
        com.seafile.vmoo.account.Account a = manager.getSeafileAccount(account);
