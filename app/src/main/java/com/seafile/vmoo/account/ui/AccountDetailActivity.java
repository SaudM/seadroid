...
//            loginButton.setEnabled(false);
            Account tmpAccount = new Account(null, null, false, null);
            progressDialog = new ProgressDialog(this);
            progressDialog.setMessage(getString(R.string.settings_cuc_loading));
            progressDialog.setCancelable(false);
            ConcurrentAsyncTask.execute(new LoginTask(tmpAccount, "3754934", null, false));
...
//                cbRemDevice.setVisibility(View.GONE);
            ...
            if (result != null && result.equals("Success")) {
                ...
                retData.putExtra(TWO_FACTOR_AUTH,false);
...
//                loginAccount = new Account(loginAccount.server, accountInfo.getEmail(), loginAccount.token, false, loginAccount
//                .sessionKey);
                loginAccount = new Account(accountInfo.getName(), loginAccount.server, accountInfo.getEmail(), loginAccount.token, false,
                        loginAccount.sessionKey);
