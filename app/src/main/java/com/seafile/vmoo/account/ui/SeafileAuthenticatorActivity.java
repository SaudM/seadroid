...
//        });
        ...
        if (getIntent().getBooleanExtra(ARG_SHIB, false)) {
            ...
            android.accounts.Account account = new android.accounts.Account(getIntent().getStringExtra(SeafileAuthenticatorActivity.ARG_ACCOUNT_NAME), com.seafile.vmoo.account.Account.ACCOUNT_TYPE);
