...
public class TransferService extends Service {
     ...
     *
     * Note: when deleting all tasks whose state is {@link TaskState#TRANSFERRING} in the queue,
     * other tasks left will never be executed, because they are all in the {@link TaskState#INIT} state.
